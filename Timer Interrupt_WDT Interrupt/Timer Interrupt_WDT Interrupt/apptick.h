...
#define MAXVAL_UWORD32 0xFFUL    /**< Constant to define the maximum value of the counter to manager the overflow */
#endif

#define MAX_TICK_FOR_MINUTE    6000  /**< Constant to define the application counter value for 1 minutes (60 sec * 100 counts/sec  ) */
  
typedef unsigned char timer_t;          /**< define the type used for all timers as a 32 bits **/
