...
extern void BLE_Init(unsigned char power);
extern void BLE_TRX(void);

extern void Fun_Test_All (void);
extern void SRCCCarrierTest(unsigned char freq, unsigned char power);
extern void SRRC_PRBS9Test(unsigned char freq, unsigned char power);
extern void RXTest(unsigned char freq);
...
extern unsigned short ble_tick;
